...
class AbonnementDao():
    ...
    def get_prix_abonnement_DAO(self, id_abonnement):
        ...
        try :
            ...
            if prix is None:
                logging.warning(f"Aucun prix trouvé pour l'abonnement ID: {id_abonnement}")
                return None
            return prix
        except Exception as e:
                logging.error(f"Erreur lors de la récupération du prix pour l'abonnement ID: {id_abonnement} - {e}")
                return None
    ...
    def get_qualite_abonnement_DAO(self, id_abonnement):
        ...
        try :
            ...
            if qualite is None:
                logging.warning(f"Aucune information sur la qualité trouvée pour l'abonnement ID: {id_abonnement}")
            return qualite
        except Exception as e:
                logging.error(f"Erreur lors de la récupération de la qualite de l'abonnement ID:{id_abonnement} - {e}")
    ...
    def get_nom_abonnement_DAO(self, id_abonnement):
        ...
        try:
            with DBConnection().connection as connection:
                ...
                if nom is None:
                    logging.warning(f"Aucun nom trouvé pour l'abonnement ID: {id_abonnement}")
                    return None  # Si aucun nom n'est trouvé, retourner None

                return nom  # Retourner le nom trouvé

        except Exception as e:
            logging.error(f"Erreur lors de la récupération du nom de l'abonnement ID: {id_abonnement} - {e}")
    ...
    def get_abonnement_by_plateforme_DAO(self, nom_plateforme):
        ...
        try :
            ...
            if abonnements_data:
                ...
                abonnements = [{"id_abonnement": abonnement['id_abonnement']} for abonnement in abonnements_data]
            else:
    ...
    def abonnement_filtrés(self, preferences: dict):
        ...
        try:
            ...
            logging.error(f"Erreur lors de la récupération des abonnements filtrés: {e}")
            return None
...
if __name__ == "__main__":
    ...
    dicti={"qualite":"HD", "pub":True, "prix":False,'rapport_quantite_prix':False}
