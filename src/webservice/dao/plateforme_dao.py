        ...
        try:
            with DBConnection().connection as connection:
                with connection.cursor() as cursor:
                    ...
                    if count > 0:
                        print(f"La plateforme avec l'ID '{plateforme.id_plateforme}' ou le nom '{plateforme.nom_plateforme}' existe déjà.")
                        return False 
                    ...
                    print(f"La plateforme '{plateforme.nom_plateforme}' a été ajoutée avec succès.")
